...
Cut it with three pieces with spli We clean it with tri We check if the age and the ID is vali Then we're going to build a person with setter
Then we're going to display if the person is an adult or under age with the getter
